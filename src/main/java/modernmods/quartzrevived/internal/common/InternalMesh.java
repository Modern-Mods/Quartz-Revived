...
import modernmods.quartzrevived.internal.util.PointerWrapper;
...
import static modernmods.quartzrevived.internal.MagicNumbers.VERTEX_BYTE_SIZE;
...
public class InternalMesh implements Mesh {
    ...
    private static class Builder implements Mesh.Builder, MultiBufferSource {
        ...
        private static class BufferBuilder implements VertexConsumer {
            ...
            @Override
            public VertexConsumer setUv1(int oU, int oV) {
